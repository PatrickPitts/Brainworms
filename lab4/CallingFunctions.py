...
"""
Date: June 23, 2021
File: Lab 4, CallingFunctions.py
...
"""
# creates a randomized list of numbers from 3 to 50, incremented by 3
numbers = createList(3, 50, 3)

# prints the list
printList(numbers)
# gets the minimum value and its index
mins = minValue(numbers)

# gets the maximum value and its index
maxs = maxValue(numbers)

# prints the results of the minimum and maximum value function calls
printResults(0, mins[0], mins[1])
printResults(1, maxs[0], maxs[1])
